...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        attention_probs_out = attention_scores
        ...
        outputs = (context_layer, attention_probs_out) if output_attentions and encoder_hidden_states is not None else (context_layer,)
    ...
    def forward(
        ...
        if self.has_cross_attention:
            ...
            if type(encoder_hidden_states) == list:
                ...
                #     attention_map = cross_attention_outputs[1]
    ...
    def forward(
        ...
        for i in range(start_layer, output_layer):
            ...
            if output_attentions:
                ...
                all_cross_attentions = layer_outputs[1]
